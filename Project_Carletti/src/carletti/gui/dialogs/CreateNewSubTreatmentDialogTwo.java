...
public class CreateNewSubTreatmentDialogTwo extends JDialog {
	...
	public CreateNewSubTreatmentDialogTwo(){
	...
	private class Controller implements ActionListener{
		...
		public void actionPerformed(ActionEvent ae) {
			...
			if (ae.getSource() == btnCreate){
				...
				CreateNewSubTreatmentDialogTwo.this.setVisible(false);
			}
	...
	/**
	 * The solution below to getting the information about a new
	 * SubTreatment isn't pretty, but it'll do for now.
	 */
